...
namespace Models
{
    public class ProductEntityConfiguration : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.Property(i => i.Name).IsRequired(true).HasMaxLength(999999999);
            ...
            builder.Property(i => i.UnitWeight).HasMaxLength(500);
            builder.Property(i => i.UserId).IsRequired(false);
            builder.Property(i => i.CategoryID).IsRequired(false);
            builder.Property(i => i.Description).HasMaxLength(999999999);
        }
    }
}
